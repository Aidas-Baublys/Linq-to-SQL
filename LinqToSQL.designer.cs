...
namespace Link_to_SQL
{
	...
	[global::System.Data.Linq.Mapping.DatabaseAttribute(Name="EchoDB")]
    ...
    partial void DeleteStudentLecture(StudentLecture instance);
		...
		public LinqToSQLDataContext() : 
				base(global::Link_to_SQL.Properties.Settings.Default.EchoDBConnectionString, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnNameChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="University_Student", Storage="_Students", ThisKey="Id", OtherKey="UniID")]
    ...
    partial void OnUniIDChanging(int value);
    partial void OnUniIDChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_UniID", DbType="Int NOT NULL")]
		public int UniID
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="University_Student", Storage="_University", ThisKey="UniID", OtherKey="Id", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
			...
			set
			{
							...
							|| (this._University.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((value != null))
					{
						...
						this._UniID = value.Id;
					}
					else
					{
						this._UniID = default(int);
					}
